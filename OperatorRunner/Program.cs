...
using RunnerExecutionContext = OperatorRunner.ExecutionContext;
...
public static class Program
{
    ...
    private static RunnerResponse ExecuteWorkflow(ExecutionPlan plan)
    {
    ...
    private static SelfEvaluation Evaluate(ExecutionPlan plan, List<string> selectedRowIds, RunnerExecutionContext context)
    {
    ...
    private static Dictionary<string, object> BuildVisualizationPayload(ExecutionPlan plan, RunnerExecutionContext context, List<string> selectedRowIds)
    {
    ...
    private static Dictionary<string, object> BuildDiagnostics(RunnerExecutionContext context)
    {
        return new Dictionary<string, object>
        {
